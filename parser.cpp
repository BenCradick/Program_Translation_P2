...
//        node->children[i] =
//    }
tokens* copy(tokens token){
    auto new_token = new tokens();
    new_token->t_type = token.t_type;
    new_token->instance = token.instance;
