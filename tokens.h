...
enum token_type{ iter_tk,void_tk,var_tk,return_tk,scan_tk,print_tk,program_tk,cond_tk,then_tk,let_tk,int_tk,id_tk,
        ...
        multiplication_tk,  division_tk,  percent_tk,  period_tk, left_parenthesis_tk, right_parenthesis_tk,
        left_curly_bracket_tk, right_curly_bracket_tk, semi_colon_tk,  left_bracket_tk, right_bracket_tk
};
